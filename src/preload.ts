...
export const API = {
    ...
    writeFile: async (file: string, contents: string) => ipcRenderer.invoke('write-file', file, contents),    semverGte: async (version1: string, version2: string) => ipcRenderer.invoke('semver-gte', version1, version2),
